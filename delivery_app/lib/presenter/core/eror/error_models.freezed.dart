...
class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl({required this.title, required this.description});
  ...
  @override
  String toString() {
    return 'ErrorModel(title: $title, description: $description)';
  }
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel(
      ...
      required final String description}) = _$ErrorModelImpl;
